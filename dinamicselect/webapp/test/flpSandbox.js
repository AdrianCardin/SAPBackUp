		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Dincamic",
									"targetURL": "#nttdatacomdinamicselect-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nttdatacomdinamicselect-display": {
								"semanticObject": "nttdatacomdinamicselect",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nttdata.com.dinamicselect",
									"url": sap.ui.require.toUrl("nttdata/com/dinamicselect")
								}
							}
						}
					}
