		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#nttdatacomdefault-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nttdatacomdefault-display": {
								"semanticObject": "nttdatacomdefault",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nttdata.com.default",
									"url": sap.ui.require.toUrl("nttdata/com/default")
								}
							}
						}
					}
