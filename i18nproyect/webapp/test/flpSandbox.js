		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "i18n",
									"targetURL": "#nttdatacomi18nproyect-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nttdatacomi18nproyect-display": {
								"semanticObject": "nttdatacomi18nproyect",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nttdata.com.i18nproyect",
									"url": sap.ui.require.toUrl("nttdata/com/i18nproyect")
								}
							}
						}
					}
