		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#nttdatacomnorthconnexion2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nttdatacomnorthconnexion2-display": {
								"semanticObject": "nttdatacomnorthconnexion2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nttdata.com.northconnexion2",
									"url": sap.ui.require.toUrl("nttdata/com/northconnexion2")
								}
							}
						}
					}
