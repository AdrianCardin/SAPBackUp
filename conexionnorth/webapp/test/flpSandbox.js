		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "tryConnexion",
									"targetURL": "#nttdatacomconexionnorth-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nttdatacomconexionnorth-display": {
								"semanticObject": "nttdatacomconexionnorth",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nttdata.com.conexionnorth",
									"url": sap.ui.require.toUrl("nttdata/com/conexionnorth")
								}
							}
						}
					}
