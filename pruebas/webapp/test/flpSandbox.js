		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "test",
									"targetURL": "#testerpruebas-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"testerpruebas-display": {
								"semanticObject": "testerpruebas",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tester.pruebas",
									"url": sap.ui.require.toUrl("tester/pruebas")
								}
							}
						}
					}
